          ...
          <div className="row">
            <div className="col-lg-7 col-md-12 content-tab wow fadeInLeft">
              <div className="wd-review-job contentbox1 style2">
                <h3>
                  Vous possédez des actifs immobiliers ?
                </h3>
                <p>
                Vous possédez des actifs immobiliers situés dans une agglomération de plus de 20 000 habitants ou en périphérie ? les experts de FoncierOnline sont capables d’intervenir sur tous les types d’actifs.
                </p>
