        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 content-tab wow fadeInRight">
            <div className="wd-review-job contentbox1">
              <h3>Je m’inscris en tant qu’investisseur</h3>
              <p>Expert en valorisation d'actifs immobiliers dans les grandes villes et périphéries, partout en france,
foncieronline vous présente un vaste panel d'actifs de tous types :</p>
